...
namespace Microsoft.Teams.Apps.NewHireOnboarding.Bot
{
    ...
    public class ActivityMiddleware : IMiddleware
    {
        ...
        public ActivityMiddleware(IOptions<BotOptions> options, ILogger<ActivityMiddleware> logger, IStringLocalizer<Strings> localizer)
        {
        ...
        {
            return (bool)turnContext.Activity?.Conversation?.TenantId.Equals(this.options.Value.TenantId, StringComparison.OrdinalIgnoreCase);
        }
    }
}
